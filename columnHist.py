...
out_folder = Path("/mnt/c/Users/ciroj/Desktop/Parquet Files/TnP/DataE_2022/nominal/Columns/histograms")
folder = Path("/mnt/c/Users/ciroj/Desktop/Parquet Files/TnP/DataE_2022/nominal/Columns")
...
for f in tqdm(parquet_files,desc="makinghistograms"):
    ...
    if counts.max()>1100000: #implements different rules for histograms that would have an excessive amount of data concentrated in one bin
        ...
        if sorted_values[0]>(2*sorted_values[1]): 
            ...
            filtered_counts = counts[mask]
        """
        mask = (counts >= np.percentile(counts,90))
        filtered_counts = counts[mask] #filters out bars with heights below the 90th percentile, necessary because this type of hist is super concentrated
        """
